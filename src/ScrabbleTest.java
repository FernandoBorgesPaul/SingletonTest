...
public class ScrabbleTest {
	...
	public static void main(String[] args) {
		...
		// Get all letters stored in the List
		...
		// Singleton instanceTwo = new Singleton(); // CONTRUCTOR SINGLETON IS NOT
		// VISILBE

		// Try getting a new instance using getIsntance()

		Singleton instanceTwo = Singleton.getInstance();

		// Get unoique ID for the new instance Object
